...
public class LoginV1 extends javax.swing.JFrame {
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        if (txtLogin.getText().equals("admin") && txtSenha.getText().equals("admin")) {
            ...
            JOptionPane.showMessageDialog(null, "Acesso LIBERADO, bem vindo usuario");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginV1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
