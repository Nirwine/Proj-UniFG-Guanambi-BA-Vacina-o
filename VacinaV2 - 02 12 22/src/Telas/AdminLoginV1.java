...
public class AdminLoginV1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtLoginadmin = new javax.swing.JFormattedTextField();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtSenhaadmin, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(59, 59, 59))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    private void btnEntraradmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntraradmActionPerformed
        ...
        try {
            usuario_admin = txtLoginadmin.getText();
            String captura = new String(txtSenhaadmin.getPassword());
            AdminService usuarioservice = new AdminService();
            ResultSet ResultSet = usuarioservice.logaradmin(usuario_admin, captura);
            if (ResultSet.next()) {
                this.dispose();
                new TelaPrincipalADM().setVisible(true);
                JOptionPane.showMessageDialog(null, "Bem vindo " + usuario_admin);
            } else {
    ...
    private javax.swing.JFormattedTextField txtLoginadmin;
